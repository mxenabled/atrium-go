 ...
 * @param optional nil or *AggregateMemberOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  An optional parameter which determines the type of aggregation to be peformed. Possible values are &#x60;statement&#x60; and &#x60;history&#x60;.

@return MemberResponseBody
*/

type AggregateMemberOpts struct {
	Type_ optional.String
}

func (a *MembersApiService) AggregateMember(ctx context.Context, memberGUID string, userGUID string, localVarOptionals *AggregateMemberOpts) (MemberResponseBody, *http.Response, error) {
	var (
...
/*
MembersApiService List member statements
...
func (a *MembersApiService) ListMemberStatements(ctx context.Context, memberGUID string, userGUID string, localVarOptionals *ListMemberStatementsOpts) (StatementsResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
