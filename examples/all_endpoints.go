...
func main() {
	...
	fmt.Println("Read User:", user.Guid)
	...
	fmt.Println("Updated Metadata:", user.Metadata)
	...
	for _, user := range users {
		fmt.Println("User Guid: ", user.Guid)
	}
	...
	for _, institution := range institutions {
		fmt.Println("Name: ", institution.Name)
	}
	...
	fmt.Println("Institution Name:", institution.Name)
	...
	for _, credential := range credentials {
		fmt.Println("Name: ", credential.FieldName)
		fmt.Println("Credential GUID: ", credential.Guid)
	}
	...
	fmt.Println("Updated Member Metadata: ", member.Metadata)
	...
	for _, member := range members {
		fmt.Println("Member Guid: ", member.Guid)
	}
	...
	fmt.Println("Aggregation Status: ", member.Status)
	...
	for _, transaction := range transactions {
		fmt.Println("Transaction Guid: ", transaction.Guid)
	}
	...
	fmt.Println("Account Guid: ", account.Guid)
	...
	fmt.Println("Connect Widget URL: ", connect.URL)
